package mobiler.abbosbek.instagramstories
...
import mobiler.abbosbek.instagramstories.ui.theme.InstagramStoriesTheme
...
fun InstagramProgressIndicator(
    ...
    var currentStepState = remember(currentStep) {
